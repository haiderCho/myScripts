...
// @version     1.2.1
// @description Easily export ChatGPT conversation history.
// @license     MIT
...
(() => {
    ...
    style.textContent = `
/* General */
.CheckBoxLabel{position:relative;display:flex;font-size:16px;vertical-align:middle;cursor:pointer}
.CheckBoxLabel[disabled]{opacity:.7;cursor:not-allowed}
.CheckBoxLabel input{position:absolute;opacity:0;width:100%;height:100%;top:0;left:0;margin:0;padding:0}
.CheckBoxLabel .IconWrapper{display:inline-flex;align-items:center;position:relative;font-size:1.5rem}
.CheckBoxLabel input:checked~svg{color:rgb(28 100 242)}
.dark .CheckBoxLabel input:checked~svg{color:rgb(144,202,249)}
.CheckBoxLabel .LabelText{margin-left:.5rem;font-size:1rem;line-height:1.5}
span[data-time-format]{display:none}
body[data-time-format="12"] span[data-time-format="12"],body[data-time-format="24"] span[data-time-format="24"]{display:inline}

/* Select & Inputs */
.Select{padding:0 .5rem;width:7.5rem;border-radius:4px;box-shadow:0 0 0 1px #6f6e77}
.dark .Select{background-color:#2f2f2f;color:#fff;box-shadow:0 0 0 1px #6f6e77}
.Input{width:100%;flex:1;border-radius:4px;padding:0 10px;font-size:15px;height:35px;outline:none;background-color:#fafafa;color:#000;box-shadow:0 0 0 1px #6f6e77}
.dark .Input{background-color:#2f2f2f;color:#fff;box-shadow:0 0 0 1px #6f6e77}

/* Dialog */
.DialogOverlay{background-color:rgba(0,0,0,.44);position:fixed;inset:0;z-index:1000;animation:fadeIn .15s cubic-bezier(.16,1,.3,1)}
.DialogContent{background-color:#f3f3f3;border-radius:6px;box-shadow:hsl(206 22% 7% / 35%) 0 10px 38px -10px,hsl(206 22% 7% / 20%) 0 10px 20px -15px;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);width:90vw;max-width:560px;max-height:85vh;overflow:auto;padding:16px 24px;z-index:1001;outline:none;animation:contentShow .15s cubic-bezier(.16,1,.3,1)}
.dark .DialogContent{background-color:#2a2a2a;border:1px solid #40414f}

/* Buttons */
.Button{display:inline-flex;align-items:center;justify-content:center;border-radius:4px;padding:0 15px;font-size:15px;line-height:1;height:35px}
.Button.green{background-color:#ddf3e4;color:#18794e}
.Button.red{background-color:#f9d9d9;color:#a71d2a}
.Button.green:hover{background-color:#ccebd7}
.Button:disabled{opacity:.5;color:#6f6e77;background-color:#e0e0e0;cursor:not-allowed}
.Button:disabled:hover{background-color:#e0e0e0}

/* Toggle Switch */
.toggle-switch{position:relative;outline:none;background-color:#e5e7eb;border:1px solid #6b7280;border-radius:9999px;cursor:pointer;height:20px;width:32px}
.dark .toggle-switch{background-color:rgba(255,255,255,.05);border-color:rgba(255,255,255,1)}
.toggle-switch[data-state="checked"]{background-color:#000;border-color:#000}
.dark .toggle-switch[data-state="checked"]{background-color:#16a34a;border-color:#16a34a}
.toggle-switch-handle{display:block;background:#fff;border-radius:9999px;height:16px;width:16px;transition:transform .1s;transform:translateX(1px)}
.toggle-switch-handle[data-state="checked"]{transform:translateX(14px)}
.toggle-switch-handle:hover{background-color:#f3f4f6}
.toggle-switch-label{color:#6b7280;margin-left:.75rem;font-size:.875rem;font-weight:500}
.toggle-switch-label:hover{color:#475569}

/* Animations */
@keyframes fadeIn{from{opacity:0}to{opacity:1}}
@keyframes slideUp{from{transform:translateY(100%)}to{transform:translateY(0)}}
@keyframes contentShow{from{opacity:0;transform:translate(-50%,-48%) scale(.96)}to{opacity:1;transform:translate(-50%,-50%) scale(1)}}
`;
